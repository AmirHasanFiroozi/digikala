...
function SeeAllBox({amazingOffers}) {
  return (
    ...
    href={"https://www.digikala.com/" + amazingOffers.see_more_url.uri}
      target="_blank"
      className="h-full mr-1 flex flex-col gap-2 items-center justify-center w-40 bg-white p-2 text-(--text-color)"
    >
        <div className="text-[#19bfd3] rounded-full border-2 p-4">
